...
CREATE TABLE `table_task1` (
  ...
  `servtype` char(20) NOT NULL DEFAULT 'hosting',
  `subtype` char(32) NOT NULL DEFAULT '',
  `user_id` int(10) NOT NULL,
  `referrer_user_id` int(9) NOT NULL,
  `state` enum('N','S','A','D','O') NOT NULL DEFAULT 'N',
...
INSERT INTO `table_task1` VALUES (35109397,'srv_vps','SSD-VPS-2-0317',664082,664082,'D','2018-02-12','08:31:24','0000-00-00 00:00:00',-3),(35109399,'srv_license_isp','lite5',664082,664082,'S','2018-02-12','08:29:22','2012-07-12 12:40:15',55);
...
-- Dump completed on 2019-07-19  8:43:26
